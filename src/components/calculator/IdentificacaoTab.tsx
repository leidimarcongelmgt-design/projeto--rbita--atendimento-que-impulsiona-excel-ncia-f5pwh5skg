      ...
      <Card className="border border-slate-200 card-shadow bg-white">
        <CardHeader className="border-b border-slate-100 pb-4">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-lg font-bold text-slate-900">
              Logotipo e Dados do Cliente
            </CardTitle>
          </div>
          <CardDescription className="text-slate-500">
            Identificação do cliente destinatário do demonstrativo financeiro.
          </CardDescription>
        </CardHeader>
        <CardContent className="pt-6 space-y-6">
      ...
      <Card className="border border-slate-200 card-shadow bg-white">
        ...
        <CardContent className="pt-6">
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-slate-500">
              Pronto para visualizar o relatório completo com cabeçalho, DRE, tributos e
              assinaturas?
            </p>
            <Button
              type="button"
              onClick={onGenerateDocument}
              className="w-full sm:w-auto bg-[#1E3A5F] hover:bg-[#16304F] text-white px-6 h-10 font-semibold shadow-sm"
            >
              Gerar Documento
            </Button>
          </div>
